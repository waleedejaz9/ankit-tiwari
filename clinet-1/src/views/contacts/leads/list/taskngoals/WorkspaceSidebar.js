        ...
        <div className="task-app-menu">
          <ListGroup className="sidebar-menu-list" options={{ wheelPropagation: false }}>
            <div className="p-1 d-flex justify-content-between align-items-center">
              <div style={{ fontSize: '16px', fontWeight: 800 }}>{WorkspaceSidebarName}</div>
            ...
            <div className="create-workspace-btn mt-1">
              <Button color="flat-dark" className="d-flex">
                <Filter size={14} />
                <span className="align-middle ms-25">Filter Lead Type</span>
              </Button>

              <div className="ms-2 mt-1">
                <Label htmlFor="facebook" className="form-label" style={{ fontSize: '14px' }}>
                  <Input id="facebook" type="checkbox" /> Facebook
                </Label>
              </div>
              <div className="ms-2 mt-1">
                <Label htmlFor="linkedin" className="form-label" style={{ fontSize: '14px' }}>
                  <Input id="linkedin" type="checkbox" /> LinkedIn
                </Label>
              </div>
              <div className="ms-2 mt-1">
                <Label htmlFor="twitter" className="form-label" style={{ fontSize: '14px' }}>
                  <Input id="twitter" type="checkbox" /> Twitter
                </Label>
              </div>
            </div>
          </ListGroup>
