...
const OtherTab = ({ selectedUser }) => {
  ...
  const DeleteOther = ({ data }) => {
    ...
    const handleDelete = () => {
      try {
        dispatch(deleteOtherAction({ memberId: _id, _id: data._id }));
  ...
  function handleEditOther() {
    dispatch(editOtherAction({ memberId: id, ...editData }));
  }
  ...
  function onDeleteConfirm() {
    dispatch(deleteOtherAction({ _id: deleteId, memberId: selectedUser?._id }));
  }
