...
export default function DocViewer({ task,attachments,setAttachments,boardDimention,setBoardDimention }) {
  ...
  // ** Context
  const { board, setBoard, signature, selectedItem, stamp, setRecipients, recipients,setHashcode,hashcode } =
