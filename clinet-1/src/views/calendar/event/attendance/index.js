...
const Attendance = (props) => {
    ...
    const markAllClickHandler = () => {
        ...
        document.querySelectorAll(".btn-group").forEach((btnGroup, index) => {
            if (editableRowsIds.indexOf(btnGroup.getAttribute("id")) > -1) {
                btnGroup.childNodes.forEach((button, index) => {
                    ...
                    } else if (button.classList.contains("came")) {
        ...
        setClearCheckState(!clearCheckState);
    }
    ...
    const [clearCheckState, setClearCheckState] = useState(false);
        ...
        <Card>
            <div className="react-dataTable">
                <DataTable
                    ...
                    columns={columns}
                    selectableRows
                    clearSelectedRows={clearCheckState}
