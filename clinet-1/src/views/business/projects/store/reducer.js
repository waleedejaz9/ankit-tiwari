...
export const projectManagement = createSlice({
  ...
  reducers: {
    ...
    rowAdd: (state, action) => {
      const { workspaceID, tableID, newRow } = action.payload;
...
export const {workspaceUpdateName, updateRow, projectActivities, projectLastSeen, getProjectsData, projectsData, addTable, tableDelete, rowAdd, rowsDelete, updatedTableColumn, workspaceDelete } = projectManagement.actions;
